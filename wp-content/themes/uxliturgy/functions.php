...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
       'name'          => 'Footer',
       'id'            => 'footer-widget',
       'description'   => __( 'Appears in footer area', 'twentysixteen' ),
...
function twentysixteen_scripts() {
	...
	// Load Font Awesome
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/font-awesome-4.6.1/css/font-awesome.min.css', array());
	// Load Bootstrap
	...
	wp_register_style( 'bootstrap-theme-css', get_template_directory_uri() . '/css/bootstrap-theme.min.css', false, NULL, 'all' );
